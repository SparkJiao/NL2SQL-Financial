...
from general_util.text2sql_evaluate_utils import evaluate_NL2SQL
from general_util.text2sql_evaluate_utils import is_float
...
def evaluate_complex_readin(table, gold_dict, pred_dict, mode='exact', single_equal=False):
    """evaluate main
